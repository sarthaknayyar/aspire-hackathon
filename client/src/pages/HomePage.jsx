  ...
  return (
    <div className="h-[65vh] w-64 p-5 rounded-2xl bg-gradient-to-b from-blue-900 to-blue-600 shadow-xl backdrop-blur-md text-white">
      <ul className="space-y-3">
        <SidebarItem icon="📺" text={<span onClick={() => setActivePage("home")} className="cursor-pointer">Appeal Dashboard</span>} />
        <SidebarItem icon="➕" text={<span onClick={() => setActivePage("newGrievanceOrganisation")} className="cursor-pointer">Lodge Public Grievance</span>} /> 
        ...
        <SidebarItem icon="✏️" text={<span onClick={() => setActivePage("profile")} className="cursor-pointer">Edit Profile</span>} />
        <SidebarItem icon="🔒" text={<span onClick={() => setActivePage("changePassword")} className="cursor-pointer">Change Password</span>} />
...
function SidebarItem({ icon, text, special }) {
  return (
    <li
