  ...
  return (
    <div className="bg-gray-100 font-sans">
      ...
      <header className="bg-green-900 text-white px-8 py-4 flex justify-between items-center shadow-md">
        ...
        <button className="bg-orange-500 px-6 py-3 rounded-md hover:bg-orange-600 transition" onClick={handleNavigate}>Submit Tasks</button>
      </header>
      ...
      <section className="relative h-96 overflow-hidden">
        ...
        >
          ...
          <div
            className="w-full h-full bg-cover bg-center"
            style={{ backgroundImage: "url('https://via.placeholder.com/1500x400?2')" }}
          ></div>
          <div
            className="w-full h-full bg-cover bg-center"
            style={{ backgroundImage: "url('https://via.placeholder.com/1500x400?3')" }}
          ></div>
          <div
            className="w-full h-full bg-cover bg-center"
            style={{ backgroundImage: "url('https://via.placeholder.com/1500x400?4')" }}
          ></div>
        </motion.div>
        <div className="absolute inset-0 flex items-center justify-center text-white">
          <h1 className="text-6xl font-extrabold drop-shadow-lg">Department</h1>
        </div>
      </section>

      {/* Features Section */}
      <section className="text-center py-20 px-6 md:px-20">
        <h2 className="text-3xl font-bold mb-12">The growth of the richest city of all time</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-white p-6 shadow-lg rounded-md">
            <img src="https://via.placeholder.com/100" alt="Feature 1" className="mx-auto mb-6" />
            <p className="text-lg">The proof of the richest city of all time</p>
          </div>
          <div className="bg-white p-6 shadow-lg rounded-md">
            <img src="https://via.placeholder.com/100" alt="Feature 2" className="mx-auto mb-6" />
            <p className="text-lg">City highlights include all attractions</p>
          </div>
          <div className="bg-white p-6 shadow-lg rounded-md">
            <img src="https://via.placeholder.com/100" alt="Feature 3" className="mx-auto mb-6" />
      ...
      <section className="bg-green-800 text-white py-20 px-6 md:px-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold">Together, We Will Move Country Forward</h2>
        </div>
